...
public class BorrowPage {
   ...
   public static void SelectClassRoom() {
      ...
      case 0: Borrow();
         break;
      case 1: SelectEachClassRoom();
         MainPage.FirstStep();
         break;
      case 2: SelectEachMeetingRoom();
         MainPage.FirstStep();
         break;
      }
   ...
   public static void SelectEachClassRoom() {
      ...
      case 0: Borrow();
         break;
      case 1: ClassRoom.getInstance001().selectTimetable();
         MainPage.FirstStep();
         break;
      case 2: ClassRoom.getInstance002().selectTimetable();
      MainPage.FirstStep();
      break;
      case 3: ClassRoom.getInstance101().selectTimetable();
      MainPage.FirstStep();
      break;
      case 4: ClassRoom.getInstance102().selectTimetable();
      MainPage.FirstStep();
      break;
      case 5: ClassRoom.getInstance201().selectTimetable();
      MainPage.FirstStep();
      break;
      case 6: ClassRoom.getInstance202().selectTimetable();
      MainPage.FirstStep();
      break;
      case 7: ClassRoom.getInstance301().selectTimetable();
      MainPage.FirstStep();
      break;
      case 8: ClassRoom.getInstance302().selectTimetable();
      MainPage.FirstStep();
      break;
      case 9: ClassRoom.getInstance401().selectTimetable();
      MainPage.FirstStep();
      break;
      }
   }
   ...
   public static void SelectEachMeetingRoom() {
      ...
      case 0: Borrow();
         break;
      case 1: MeetingRoom.getInstanceKAS().selectTimetable();
         MainPage.FirstStep();
         break;
      case 2: MeetingRoom.getInstanceKAB().selectTimetable();
      MainPage.FirstStep();
      break;
      case 3: MeetingRoom.getInstanceLMR().selectTimetable();
      MainPage.FirstStep();
      break;
      case 4: MeetingRoom.getInstanceEMR().selectTimetable();
      MainPage.FirstStep();
      break;
      case 5: MeetingRoom.getInstanceLiMR().selectTimetable();
      MainPage.FirstStep();
      break;
      }
   }
