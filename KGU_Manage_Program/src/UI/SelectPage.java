...
public class SelectPage {
	...
	public static void loadclassRoom() {
		...
		case 0:
			...
			break;
		case 1:
			ClassRoom.getInstance001().showTimeTable();
			MainPage.FirstStep();
			break;
		case 2:
			ClassRoom.getInstance002().showTimeTable();
			MainPage.FirstStep();
			break;
		case 3:
			ClassRoom.getInstance101().showTimeTable();
			MainPage.FirstStep();
			break;
		case 4:
			ClassRoom.getInstance102().showTimeTable();
			MainPage.FirstStep();
			break;
		case 5:
			ClassRoom.getInstance201().showTimeTable();
			MainPage.FirstStep();
			break;
		case 6:
			ClassRoom.getInstance202().showTimeTable();
			MainPage.FirstStep();
			break;
		case 7:
			ClassRoom.getInstance301().showTimeTable();
			MainPage.FirstStep();
			break;
		case 8:
			ClassRoom.getInstance302().showTimeTable();
			MainPage.FirstStep();
			break;
		case 9:
			ClassRoom.getInstance401().showTimeTable();
			MainPage.FirstStep();
			break;
		}
	}
	...
	public static void loadMeetingRoom() {
		...
		case 0:
			...
			break;
		case 1:
			MeetingRoom.getInstanceKAS().showTimeTable();
			MainPage.FirstStep();
			break;
		case 2:
			MeetingRoom.getInstanceKAB().showTimeTable();
			MainPage.FirstStep();
			break;
		case 3:
			MeetingRoom.getInstanceLMR().showTimeTable();
			MainPage.FirstStep();
			break;
		case 4:
			MeetingRoom.getInstanceEMR().showTimeTable();
			MainPage.FirstStep();
			break;
		case 5:
			MeetingRoom.getInstanceLiMR().showTimeTable();
			MainPage.FirstStep();
			break;
		}
	}
